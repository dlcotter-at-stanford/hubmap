create or replace function metadata.get_proteomics_metadata(p_subject_bk varchar(100) default null, p_sample_bk varchar(100) default null)
returns table
...
as $$
  select
    ...
    ,lc_id_value
    ,lc_id_unit
    ,lc_flow_rate --correct to "_value" later
    ,lc_flow_rate_unit
    ,lc_gradient
    ,lc_mobile_phase_a
    ,lc_mobile_phase_b
